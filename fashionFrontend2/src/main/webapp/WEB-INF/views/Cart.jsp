            ...
            <table class="table table-hover">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <div class="media">
                            <a class="thumbnail pull-left" href="#"> <img class="media-object" src="<c:url value="D:/Devops project/fashionFrontend2/src/main/resources/images/${cartItem.productId}.jpg"/>" style="width: 72px; height: 72px;"> </a>
